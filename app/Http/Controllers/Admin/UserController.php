...
class UserController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/User/Index', [
            ...
            'roles' => $roles,
            'locations' => $locations,
            'filters' => $request->only(['search', 'role_id', 'location_id', 'per_page']),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->only(['name', 'nip', 'email', 'role_id', 'position', 'location_id', 'status_fit']);
    ...
    public function export(Request $request)
    {
        return Excel::download(
            new UserExport($request->role_id, $request->location_id, $request->search),
            'data_petugas.xlsx'
        );
    }
