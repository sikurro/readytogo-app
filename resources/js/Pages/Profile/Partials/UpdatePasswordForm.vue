...
<template>
    <section>
        <header>
            <h2 class="text-lg font-bold text-slate-100">Perbarui Kata Sandi</h2>

            <p class="mt-1 text-sm text-slate-400">
                Pastikan akun Anda menggunakan kata sandi yang panjang dan acak demi keamanan akun K3.
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton :disabled="form.processing">Perbarui Kata Sandi</PrimaryButton>
